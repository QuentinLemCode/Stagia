...
class CommentaireController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('StagiaAppBundle:Commentaire')->findAll();

        return $this->render('StagiaAppBundle:Commentaire:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('StagiaAppBundle:Commentaire:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('StagiaAppBundle:Commentaire')->find($id);
        ...
        return $this->render('StagiaAppBundle:Commentaire:show.html.twig', array(
            'entity'      => $entity,
